...
public class Igrac2 extends Agent {
    ...
    public class IgrajMonopoly extends SequentialBehaviour {
        ...
        public void sljedeciIgrac() {
            System.out.println("sljedeci igrac moze igrati -> Stef");
            ACLMessage poruka = new ACLMessage(ACLMessage.QUERY_REF);
            poruka.addReceiver(new AID("Stef", AID.ISLOCALNAME));
            poruka.setContent("Stef, ja sam zavrsio. Mozes bacati kockicu. Ivo");
            System.out.println("-----------------------------------------------");
            try {
                sleep(4000);
