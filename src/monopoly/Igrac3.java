    ...
    public class IgrajMonopoly extends SequentialBehaviour {
        ...
        public void kupiMjesto(Polje polje) {
            if (strategija(polje)) {
                ...
                System.out.println("Ne zelim kupovati zbog svoje strategije -> kupujem samo jeftino do zatvora");
            }
        }
        ...
        public void sljedeciIgrac() {
            ...
            try {
                ...
                Logger.getLogger(Igrac3.class.getName()).log(Level.SEVERE, null, ex);
            }
            send(poruka);
        }
    }
